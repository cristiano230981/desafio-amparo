<template>
  <div id="pagination">
    <nav class="pagination is-centered">
      <a class="pagination-previous" v-if="current > 1" @click="onChange(current - 1)">&larr; Anterior</a>
      <a class="pagination-next" v-if="size > 1 && current < size" @click="onChange(current + 1)">Próximo &rarr;</a>
